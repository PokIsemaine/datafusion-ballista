...
from proto import brain_server_pb2 as proto_dot_brain__server__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in proto/brain_server_pb2_grpc.py depends on'
...
def add_BrainServerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'brain_server.protobuf.BrainServer', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('brain_server.protobuf.BrainServer', rpc_method_handlers)
